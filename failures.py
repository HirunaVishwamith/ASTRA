...
These are applied on top of the "geometric" topology to create more realistic
scenarios: intermittent blackouts, latency spikes, and link degradation.
"""
...
class FailureModel:
    ...
    def apply(self, graph: NetworkGraph, dt_s: float) -> None:
        # iterate undirected edges, then update both directions
        ...
        # Collect keys first because we may delete.
        to_remove = []
